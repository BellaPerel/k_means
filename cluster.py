...
class Cluster:
    ...
    def compute_centroid(self):
        ...
        # Rearrange points coordinates to lists (list of X's, Y's, Z's, etc.)
        for i in range(number_of_coordinates):
            lists_of_coordinates = []
            for point in self._points:
                lists_of_coordinates.append(point.coordinates[i])
            # calculate median of each list coordinates
            new_coordinates[i] = median(lists_of_coordinates)
        # set centroid according to median of each list
